module github.com/pengdacn/levelqueue/example

go 1.18

require (
	github.com/pengdacn/levelqueue v0.1.0
	github.com/pengdacn/levelqueue/extutil v0.0.0-20230113063633-d6cdcf56ec4a
)
